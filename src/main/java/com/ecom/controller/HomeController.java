...
public class HomeController {
	...
	public String product(@PathVariable int id, Model m) {
	    ...
	    List<Review> productReviews = productService.getProductReviews(id);
	    m.addAttribute("productReviews", productReviews);
		return "view_product";
	}
	...
	public String saveUser(@ModelAttribute UserDtls user, @RequestParam("img") MultipartFile file, HttpSession session)
		...
		/*	String imageName = file.isEmpty() ? "default.jpg" : file.getOriginalFilename();
			...
			if (!ObjectUtils.isEmpty(saveUser)) {
				if (!file.isEmpty()) {
				  ...
				  //  userService.saveUser(user);
				    ...
				    // user saveUser already called hai upar, so bas image name set kar diya
				    // Wait - user save hone se pehle image name set karna hoga, isliye...
			...
			user.setProfileImage("default.jpg"); // temporary
	        UserDtls saveUser = userService.saveUser(user);
